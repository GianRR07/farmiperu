        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-center items-center">
          ...
          <div className="perspective" onClick={() => setMisionFlipped(!misionFlipped)}>
            <div className={`flip-card ${misionFlipped ? 'flipped' : ''}`}>
              ...
              <div className="flip-card-back bg-white border rounded-lg p-10 shadow-md text-ml text-gray-700 flex items-center justify-center text-center">
                ...
                cuidar la salud con excelentes asesoramientos farmacéuticos, solucionando los
                diversos problemas de salud de la comunidad, acorde a las exigencias de las
                familias peruanas.
              </div>
            </div>
          </div>
          ...
          <div className="perspective" onClick={() => setVisionFlipped(!visionFlipped)}>
            <div className={`flip-card ${visionFlipped ? 'flipped' : ''}`}>
              ...
              <div className="flip-card-back bg-white border rounded-lg p-10 shadow-md text-ml text-gray-700 flex items-center justify-center text-center">
                Ser el establecimiento farmacéutico peruano con autenticidad, reconocimiento y
                aceptación por los ciudadanos en cuidado del bienestar y la salud de todas las
                familias peruanas.
              </div>
            </div>
          </div>
        ...
        <section className="mt-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center space-y-2">
              <img src="/images/valor1.PNG" alt="valor1" className="mx-auto w-24 h-24 object-contain" />
              <p className="text-sm text-gray-700">
                Personas capacitadas y<br />honestas al cumplir sus funciones
              </p>
            </div>
            <div className="text-center space-y-2">
              <img src="/images/valor2.PNG" alt="valor2" className="mx-auto w-24 h-24 object-contain" />
              <p className="text-sm text-gray-700">
                Dedicados a la atención personalizada<br />de nuestros pacientes y sus necesidades
              </p>
            </div>
            <div className="text-center space-y-2">
              <img src="/images/valor3.PNG" alt="valor3" className="mx-auto w-24 h-24 object-contain" />
              <p className="text-sm text-gray-700">
                Comprometidos con la salud y<br />el bienestar de nuestros pacientes
              </p>
            </div>
            <div className="text-center space-y-2">
              <img src="/images/valor4.PNG" alt="valor4" className="mx-auto w-24 h-24 object-contain" />
              <p className="text-sm text-gray-700">
                Personal con liderazgo<br />absoluto
              </p>
            </div>
          </div>
        </section>
