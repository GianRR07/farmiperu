  ...
  return (
    <div className="bg-white min-h-screen py-16 px-4 sm:px-8 lg:px-24 ">
      <main className="max-w-7xl mx-auto">
        <h2 className="text-4xl font-bold text-center text-red-600 mb-20 mt-25">¡Mantente en línea!</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 ">
          ...
          <div className="space-y-8">
            ...
            <div>
              <h3 className="text-2xl font-semibold text-red-700 mb-2">Escríbenos</h3>
              <p className="text-gray-700">corporacionqf@farmaciasperu.pe</p>
            </div>

            <div>
              <h3 className="text-2xl font-semibold text-red-700 mb-2">Visítanos en</h3>
            ...
            <div>
              <h3 className="text-2xl font-semibold text-red-700 mb-2">Habla con nosotros directamente</h3>
